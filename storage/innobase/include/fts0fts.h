...
static const Lex_cstring FTS_DOC_ID_COL_NAME_ls= "FTS_DOC_ID"_LEX_CSTRING;

/** The name of the index created by FTS */
static const Lex_cstring FTS_DOC_ID_INDEX_NAME_ls= "FTS_DOC_ID_INDEX"_LEX_CSTRING;
